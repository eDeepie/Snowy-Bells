...
var snowStorm = function (g, f) {
    ...
    this.followMouse = !0;
    this.snowColor = "#e0f3ff";
    this.snowCharacter = "<li style='box-shadow:50px 50px 50px #000000;'>;";
    this.snowStick = !0;
    ...
    this.flakeHeight = this.flakeWidth = 28;
    this.vMaxX = 5;
    this.vMaxY = 4;
    this.zIndex = 0;
    var a = this,
    ...
    this.SnowFlake = function (c, d, e) {
        ...
        this.active = 1;
        this.fontSize = 20 + 20 * (this.type / 5);
        ...
        this.melt = function () {
            !a.useMeltEffect || !b.melting ? b.recycle() : b.meltFrame < b.meltFrameCount ? (b.setOpacity(b.o, b.meltFrames[b.meltFrame]), b.o.style.fontSize = b.fontSize - b.fontSize * (b.meltFrame / b.meltFrameCount) + "px", b.o.style.lineHeight = a.flakeHeight + 2 + 0.75 * a.flakeHeight * (b.meltFrame / b.meltFrameCount) + "10px", b.meltFrame++) : b.recycle()
        };
